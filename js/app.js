class CalorieTracker {
  ...
  _displayCaloriesLimit() {
    const _CaloriesLimitEl = document.getElementById('calories-limit');
    _CaloriesLimitEl.innerHTML = this._calorieLimit;
  }
...
class App {
  constructor() {
    ...
    document
      ...
      .addEventListener('submit', this._setLimtt.bind(this));
  }
